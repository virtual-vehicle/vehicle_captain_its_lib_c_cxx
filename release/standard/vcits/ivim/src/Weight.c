...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
asn_TYPE_member_t asn_MBR_Weight_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Weight, value),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Weight, unit),
...
static const ber_tlv_tag_t asn_DEF_Weight_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_Weight_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* value */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* unit */
};
asn_SEQUENCE_specifics_t asn_SPC_Weight_specs_1 = {
	sizeof(struct Weight),
	offsetof(struct Weight, _asn_ctx),
	asn_MAP_Weight_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_Weight = {
	"Weight",
	"Weight",
	&asn_OP_SEQUENCE,
	asn_DEF_Weight_tags_1,
	sizeof(asn_DEF_Weight_tags_1)
		/sizeof(asn_DEF_Weight_tags_1[0]), /* 1 */
	asn_DEF_Weight_tags_1,	/* Same as above */
	sizeof(asn_DEF_Weight_tags_1)
		/sizeof(asn_DEF_Weight_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_Weight_1,
	2,	/* Elements count */
	&asn_SPC_Weight_specs_1	/* Additional specs */
};
