...
static asn_per_constraints_t asn_PER_type_PositioningSolutionType_constr_1 CC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_PositioningSolutionType_specs_1 = {
