...
static asn_per_constraints_t asn_PER_type_TrafficRule_constr_1 CC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_TrafficRule_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_TrafficRule = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_TrafficRule_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
