...
jer_type_encoder_f TrajectoryInterceptionProbability_encode_jer;
...
per_type_decoder_f TrajectoryInterceptionProbability_decode_aper;
per_type_encoder_f TrajectoryInterceptionProbability_encode_aper;
