...
asn_struct_print_f TrailerPresenceInformation_print;
...
jer_type_encoder_f TrailerPresenceInformation_encode_jer;
oer_type_decoder_f TrailerPresenceInformation_decode_oer;
oer_type_encoder_f TrailerPresenceInformation_encode_oer;
per_type_decoder_f TrailerPresenceInformation_decode_uper;
per_type_encoder_f TrailerPresenceInformation_encode_uper;
per_type_decoder_f TrailerPresenceInformation_decode_aper;
per_type_encoder_f TrailerPresenceInformation_encode_aper;
