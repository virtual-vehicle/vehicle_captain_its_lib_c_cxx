...
static asn_oer_constraints_t asn_OER_type_LowerTriangularPositiveSemidefiniteMatrixColumns_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..13)) */};
...
asn_TYPE_descriptor_t asn_DEF_LowerTriangularPositiveSemidefiniteMatrixColumns = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_LowerTriangularPositiveSemidefiniteMatrixColumns_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
